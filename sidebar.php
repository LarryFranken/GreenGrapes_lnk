<aside id="sidebar">
    ...
    <aside >
        <div class="panel panel-green hidden-xs">
            <div class="panel-heading"><i class="fa fa-tags fa-fw"></i> 分类</div>
            <div class="list_all container">
                <?php 
                    $ahh=$this->widget('Widget_Metas_Category_List')->listCategories('wrapClass=list_list'); 
                ?>
            </div> 
